...
static void get_filetype(char *name, char *type);
...
static void doit(int fd)
{
   ...
   if (strcasecmp(method, "GET")) {
      clienterror(fd, method, "501", "Not implemented.",
                  "Tiny doesn't implement this function...");
      return;
   }
...
int main(int argc, char **argv)
{
   ...
   while (1) {
      ...
      /* SA = socketaddr, a general definition for all kinds of socket addr */
